    ...
    <div className="flex flex-col min-h-screen" style={{ background: 'var(--app-bg)' }}>
      <header className="bg-[#D0C4AE]" style={{ boxShadow: '0 1px 4px rgba(0,0,0,.18)' }}>
        <div className="container mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <span className="text-xs text-[#3d2e1e]/60 font-medium uppercase tracking-wider">Settings</span>
        </div>
      </header>
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-base font-semibold flex items-center">
              <span className="material-icons text-[#3d2e1e] mr-2 text-lg">info</span>
              About
            </CardTitle>
